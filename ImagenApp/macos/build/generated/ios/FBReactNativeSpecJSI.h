...
protected:
  NativePlatformConstantsMacOSCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativePlatformConstantsMacOSCxxSpec::kModuleName}, jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}
...
public:
  ...
  static constexpr std::string_view kModuleName = "RCTAddressSanitizerCrash";

protected:
  NativeAddressSanitizerCrashCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeAddressSanitizerCrashCxxSpec::kModuleName}, jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}
